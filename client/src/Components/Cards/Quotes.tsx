...
import { QuotesText1, QuotesText2, QuotesText3 } from '../../Utils/constants'
...
const Quotes = () => {
  ...
  return (
    <Stack direction={'row'} justifyContent={'center'} spacing={4} padding={2}>
      <Box width={'300px'}>
        <Card>
          <CardMedia component='img' height={'140px'} image={`${image1}`} />
      ...
      <Box width={'300px'}>
        <Card>
          <CardMedia component='img' height={'140px'} image={`${image2}`} />
          <CardContent sx={{height:'140px'}}>
            <Typography variant='body2' color='text.secondary'>
              {QuotesText2}  
            </Typography>
      ...
      <Box width={'300px'}>
        <Card>
          <CardMedia component='img' height={'140px'} image={`${image3}`} />
          <CardContent sx={{height:'140px'}}>
            <Typography variant='body2' color='text.secondary'>
              {QuotesText3}  
            </Typography>
